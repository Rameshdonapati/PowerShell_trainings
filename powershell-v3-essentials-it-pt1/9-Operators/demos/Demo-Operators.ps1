...
if(5 -lt 3){write-host "do ths task" -ForegroundColor Green  }
100 -lt 90
11 -le 11
...
$x = 123 ; $x
if($x -eq 123){write-host "do Task"}
$x += 2 ; $x 
$x -= 23 ; $x
$x /= 3 ; $x
$x++ ; $x
...
90..75
1..10 | foreach {
 Write-Host "Adding JoeTest $_" -ForegroundColor green
}
