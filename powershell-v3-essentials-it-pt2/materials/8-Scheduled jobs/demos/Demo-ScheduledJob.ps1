...
$action = { 
 get-eventlog system -EntryType Error,Warning -After (Get-Date).AddHours(-24) -Newest 5
 }
...
$scriptpath = "D:\Trainings\PS_Training\powershell-v3-essentials-it-pt2\materials\7-BackgroundJobs\demos\get-diskspace.ps1"
$jobParams = @{
 Name="DiskReport"
